...
string@[] cols = { "#advparts", "#electronics", "#metals", "#food", "#goods", "#luxuries", "#fuel", "#ammo"};
string@[] stats = { "AdvParts", "Electronics", "Metals", "Food", "Guds", "Luxs", "Fuel", "Ammo"};
uint[] headingColors = { 0xffc2e4ff, 0xfff6ff00, 0xffeaeaea, 0xff197b30, 0xff987433, 0xffffb9b9, 0xffff8500, 0xffb54f4a};
